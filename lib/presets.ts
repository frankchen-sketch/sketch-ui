...
export const BUILTIN_PRESETS: ProjectPreset[] = [
  ...
  },
  {
    key: "furriq",
    name: "Furriq",
    description: "猫品种识别 App",
    icon: "🐱",
    seedColor: "#8a4b18",
    theme: { shape: "rounded" },
    promptPrefix: "Project: Furriq — a cat breed identification web app. Tech: TanStack Start + React + Tailwind CSS. Style: warm earthy tones, trustworthy and professional.",
    promptSuffix: "Use Tailwind CSS utility classes. Responsive mobile-first. Accessible (WCAG AA).",
  },
  {
    key: "meowtrail",
    name: "MeowTrail",
    description: "猫主题逻辑谜题游戏",
    icon: "🧩",
    seedColor: "#7B6B8A",
    theme: { shape: "rounded" },
    promptPrefix: "Project: MeowTrail — a cat-themed Akari (Light Up) logic puzzle game. Tech: Astro + TypeScript. Style: soft pastel, cute clay cat mascots, inviting for all ages.",
    promptSuffix: "Deploy to Cloudflare Pages. Static output. Include GA4 event tracking.",
  },
  {
    key: "meowblock",
    name: "MeowBlock",
    description: "猫主题矩形分割游戏",
    icon: "📐",
    seedColor: "#FF42A5",
    theme: { shape: "rounded" },
    promptPrefix: "Project: MeowBlock — a cat-themed Shikaku (rectangle partition) puzzle game. Tech: Astro + TypeScript. Style: playful pink, CSS cat blocks, fun and energetic.",
    promptSuffix: "Deploy to Cloudflare Pages. Static output.",
  },
  {
    key: "gridpaw",
    name: "GridPaw",
    description: "逻辑谜题游戏合集站",
    icon: "🐾",
    seedColor: "#D97706",
    theme: { shape: "rounded" },
    promptPrefix: "Project: GridPaw — a collection of logic puzzle games (Shikaku, Akari, Pictomino). Tech: Astro + TypeScript. Style: warm amber branding, clean game UI.",
    promptSuffix: "Deploy to Cloudflare Pages. Responsive. Include daily challenge system.",
  },
];
